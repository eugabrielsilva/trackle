...
$baseUrl = $protocol . $_SERVER['HTTP_HOST'] . '/' . ($folder !== '' ? $folder . '/' : '');
?>
...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootswatch/5.3.8/vapor/bootstrap.min.css">
