...
Baseado no finado **Heardle**, este jogo é gratuito e utiliza dados fornecidos pela API do Deezer. Todos os direitos sobre as obras pertencem aos seus respectivos artistas e gravadoras.
...
Basta colocar os arquivos na pasta `www` ou `public_html` (dependendo da sua instalação do Apache) e acessar a URL do servidor.
...
### Não é permitido reproduzir este jogo com fins lucrativos, anúncios ou qualquer forma de monetização
